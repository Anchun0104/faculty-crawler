...
class AiSettingsPage(QWidget):
    ...
    def __init__(self, facade: object, parent: QWidget | None = None) -> None:
        ...
        self.setAccessibleName("翻译与 AI 设置")
    ...
    def _build(self) -> None:
        ...
        self.enabled_checkbox.setAccessibleName("启用外部 AI 辅助")
        ...
        self.provider_combo.setAccessibleName("AI 服务商")
        ...
        self.model_edit.setAccessibleName("AI 模型")
        ...
        self.key_status.setAccessibleName("API Key 状态")
        ...
        self.connection_status.setAccessibleName("AI 连接状态")
        ...
        self.budget_input.setAccessibleName("默认任务预算（美元）")
        ...
        self.usage_table.setAccessibleName("AI 用量明细")
